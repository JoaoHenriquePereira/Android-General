    	            ...
    	            if (isConnected) {
    	            	...
    	            	if(isSupported){
    	            		...
    	            		if(isOnline){
    	            			...
    	            			if(signalStrength < min_wifi_level){
        	    	                ...
        	    	                connectSup(getBestSupSignal(available_wifis));
    	            			}
    	            	...
    	            	//Device is connected to a non-supported Network	
    	            		...
    	            		if(!isOnline){
    	    	                ...
    	    	                //Para quando quisermos dar ao user opcao de escolha
...
private boolean notify(int notification_id){
			...
			Intent resultIntent = new Intent(this, WiFlowActivity.class);
			...
			stackBuilder.addParentStack(WiFlowActivity.class);
			...
			if(settings.getBoolean("vibrate_setting", false))
	    		vibrate = new long[]{100,200,300};
	    	if(settings.getBoolean("ring_tone_setting", false))
	    		sound = Uri.withAppendedPath(Audio.Media.INTERNAL_CONTENT_URI, "6");
			
			switch(notification_id){
			
		    	//Online at ZON FON	
		    	case 1:	content_title = "You're Online";
		    			content_text = "Logged in at ZON Fon";
		    			bm = BitmapFactory.decodeResource(getResources(), R.drawable.notification_large);
		    			break;
		    	
		    	//Wrong Credentials at ZON FON	
		    	case 2:	content_title = "Login Failed";
		    			content_text = "Wrong username or password at ZON Fon";
		    			bm = BitmapFactory.decodeResource(getResources(), R.drawable.notification_large);
		    			break;		
		    			
		    	//Online at PT-Wifi	
		    	case 3:	content_title = "You're Online";
		    			content_text = "Logged in at WiFi PT";
		    			bm = BitmapFactory.decodeResource(getResources(), R.drawable.notification_large);
		    			break;
		    	
		    	//Wrong Credentials at PT-Wifi	
		    	case 4:	content_title = "Login Failed";
		    			content_text = "Wrong username or password at WiFi PT";
		    			bm = BitmapFactory.decodeResource(getResources(), R.drawable.notification_large);
		    			break;
		    	
		    			//WiFlow Service on	
		    	case 5:	content_title = "WiFlow Service On";
		    			content_text = "WiFlow is monitoring WiFi HotSpots";
		    			bm = BitmapFactory.decodeResource(getResources(), R.drawable.notification_large);
		    			break;
			...
			try{
				...
				NotificationCompat.Builder mBuilder =
					    ...
					    .setSmallIcon(R.drawable.logowiflow_96x96)
						.setLargeIcon(bm)
